      ...
      const mockCompanies: Company[] = [
        {
          ...
          cnpj: '12345678000190',
          healthScore: 80,
          kpi1: { id: '1', label: 'KPI 1', current: 50, target: 100 },
          kpi2: { id: '2', label: 'KPI 2', current: 60, target: 100 },
          kpi3: { id: '3', label: 'KPI 3', current: 70, target: 100 }
        },
        {
          id: 'company2',
          name: 'Company B',
          cnpj: '98765432000100',
          healthScore: 90,
          kpi1: { id: '1', label: 'KPI 1', current: 80, target: 100 },
          kpi2: { id: '2', label: 'KPI 2', current: 85, target: 100 },
          kpi3: { id: '3', label: 'KPI 3', current: 90, target: 100 }
        }
      ];
